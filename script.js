...
function translateText() {
  ...
  for (let char of inputText) {
    const imgSrc = getImageForCharacter(char); // Utilise la casse originale pour l’image
    const pronunciation = getPronunciationForCharacter(char); // Utilise la casse originale pour la prononciation
...
function getPronunciationForCharacter(char) {
  const charToPronunciationMap = {
    'a': 'hè-', 'b': 'ba-', 'c': 'da-', 'd': 'bo-', 'e': 'é-', 'f': 'è-',
    'g': 'la-', 'h': 'lo-', 'i': 'pi-', 'j': 'pa-', 'k': 'je-', 'l': 'ja-',
    'm': 'mo-', 'n': 'mu-', 'o': 'do-', 'p': 'ké-', 'q': 'ka-', 'r': 'ri-',
    's': 'zi-', 't': 'ou-', 'u': 'ille-', 'v': 'oui-', 'w': 'oua-', 'x': 'ak-',
    'y': 'ik-', 'z': 'oy-', 
    ...
    '0': 'ouss-', '1': 'ouz-', '2': 'ouk-', '3': 'oup-', '4': 'oud-', 
    '5': 'oub-', '6': 'oul-', '7': 'out-', '8': 'ouf-', '9': 'ouve-', ' ': ''
  };
